...
\begin{theorem}[{The Szemerédi Regularity Lemma \cite{Sz75}}]For every $\varepsilon > 0$, and let $m \in  \mathbb{N}$. There exists a constant $M=M(\varepsilon)$ such that the following holds.\\
